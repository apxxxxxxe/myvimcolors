...
let s:p.normal.left = [ [ s:black, s:darkblue ], [ s:black, s:purple ], [ s:black, s:darkblue ] ]
...
let g:lightline#colorscheme#mylightlinewal#palette = lightline#colorscheme#flatten(s:p)
