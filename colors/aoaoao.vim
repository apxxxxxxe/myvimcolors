...
" Colors base
let s:primary       =   '#048080'
let s:secondary     =   '#808004'
...
call s:hi('MatchParen', s:source, s:match, s:none)
call s:hi('ColorColumn', s:source, s:sub, s:none)
...
call s:hi('Pmenu', s:source, s:sub, s:none)
