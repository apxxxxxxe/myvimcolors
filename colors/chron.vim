...
" Colors base
let s:primary       =   '#592534'
let s:secondary     =   '#9A464E'
let s:accent        =   '#8B8573'
...
call s:hi('TabLineSel', s:secondary, s:bg, s:none)
call s:hi('TabLine', s:bg, s:primary, s:none)
call s:hi('TabLineFill', s:primary, s:primary, s:none)

call s:hi('Comment', s:comment, s:bg, s:none)
call s:hi('Constant', s:secondary, s:bg, s:none)
...
call s:hi('Identifier', s:secondary, s:bg, s:none)
call s:hi('Function', s:primary, s:bg, s:bold)
...
call s:hi('Label', s:secondary, s:bg, s:none)
call s:hi('Operator', s:secondary, s:bg, s:none)
call s:hi('Keyword', s:secondary, s:bg, s:none)
call s:hi('Exception', s:secondary, s:bg, s:none)

call s:hi('PreProc', s:fg, s:bg, s:none)
call s:hi('Include', s:secondary, s:bg, s:none)
call s:hi('Define', s:fg, s:bg, s:none)
call s:hi('Macro', s:fg, s:bg, s:none)
call s:hi('PreCondit', s:secondary, s:bg, s:none)

call s:hi('Type', s:primary, s:bg, s:bold)
call s:hi('StorageClass', s:secondary, s:bg, s:none)
call s:hi('Structure', s:secondary, s:bg, s:none)
call s:hi('Typedef', s:secondary, s:bg, s:none)

call s:hi('Special', s:fg, s:bg, s:none)
call s:hi('SpecialChar', s:secondary, s:bg, s:none)
call s:hi('Delimiter', s:fg, s:bg, s:none)
call s:hi('SpecialComment', s:comment, s:bg, s:none)
call s:hi('Debug', s:secondary, s:bg, s:none)
call s:hi('Underlined', s:fg, s:bg, s:underline)
call s:hi('Todo', s:secondary, s:bg, s:none)
...
call s:hi('SpecialKey', s:bg, s:comment, s:none)

call s:hi('Folded', s:fg, s:comment, s:none)
call s:hi('FoldColumn', s:fg, s:bg, s:none)
...
call s:hi('SignColumn', s:bg, s:primary, s:none)
...
call s:hi('jinjaOperator', s:secondary, s:bg, s:none)

" PHP
call s:hi('phpDefine', s:secondary, s:bg, s:none)
...
call s:hi('jsFunction', s:secondary, s:bg, s:none)
call s:hi('jsFuncName', s:primary, s:bg, s:bold)
call s:hi('jsArrowFunction', s:secondary, s:bg, s:none)
call s:hi('jsonKeyword', s:fg, s:bg, s:none)

" Typescript
call s:hi('typescriptBraces', s:fg, s:bg, s:none)
call s:hi('typescriptDecorator', s:primary, s:bg, s:bold)
call s:hi('typescriptImport', s:secondary, s:bg, s:none)
call s:hi('typescriptExport', s:secondary, s:bg, s:none)

" Java
call s:hi('javaAnnotation', s:primary, s:bg, s:bold)

" HTML
call s:hi('htmlTagName', s:secondary, s:bg, s:none)
call s:hi('htmlTag', s:secondary, s:bg, s:none)
call s:hi('Identifier', s:secondary, s:bg, s:none)
call s:hi('htmlArg', s:primary, s:bg, s:bold)
...
" Ruby
call s:hi('rubyModule', s:secondary, s:bg, s:none)
call s:hi('rubyDefine', s:secondary, s:bg, s:none)
call s:hi('rubyClass', s:secondary, s:bg, s:none)
call s:hi('rubyFunction', s:fg, s:bg, s:none)

" Clojure
call s:hi('clojureSpecial', s:secondary, s:bg, s:none)
call s:hi('clojureDefine', s:secondary, s:bg, s:none)
