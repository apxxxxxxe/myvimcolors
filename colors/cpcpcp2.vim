...
" Colors base
let s:primary       =   '#303030'
let s:socondary     =   '#303030'
let s:accent        =   '#b83d3d'
...
call s:hi('String', s:string, s:base, s:bold)
call s:hi('Character', s:string, s:base, s:bold)
call s:hi('Number', s:const, s:base, s:bold)
call s:hi('Boolean', s:const, s:base, s:bold)
call s:hi('Float', s:const, s:base, s:bold)
...
call s:hi('Error', s:const, s:base, s:bold)
call s:hi('ErrorMsg', s:const, s:base, s:bold)
call s:hi('Question', s:string, s:base, s:bold)
call s:hi('WarningMsg', s:socondary, s:none, s:none)
call s:hi('Search', s:base, s:fg, s:none)

call s:hi('Directory', s:string, s:base, s:bold)
...
call s:hi('CursorLineNr', s:accent, s:base, s:bold)
call s:hi('VertSplit', s:sub, s:base, s:none)
call s:hi('Title', s:const, s:base, s:bold)
call s:hi('Pmenu', s:fg, s:sub, s:none)
call s:hi('PmenuSel', s:base, s:fg, s:none)
call s:hi('SpecialKey', s:fg, s:base, s:none)
...
call s:hi('pythonBuiltin', s:const, s:base, s:bold)
call s:hi('pythonDecoratorName', s:const, s:base, s:bold)
call s:hi('pythonDecorator', s:const, s:base, s:bold)
call s:hi('pythonOperator', s:socondary, s:base, s:none)
call s:hi('jinjaTagDelim', s:const, s:base, s:bold)
call s:hi('jinjaVarBlock', s:const, s:base, s:bold)
call s:hi('jinjaStatement', s:const, s:base, s:bold)
call s:hi('jinjaBlockName', s:fg, s:base, s:none)
call s:hi('jinjaVariable', s:fg, s:base, s:none)
call s:hi('jinjaString', s:string, s:base, s:bold)
...
call s:hi('bladeKeyword', s:const, s:base, s:bold)

" Javascript
call s:hi('jsNull', s:const, s:base, s:bold)
call s:hi('jsUndefined', s:const, s:base, s:bold)
...
" NERDTree
call s:hi('NERDTreeClosable', s:string, s:base, s:bold)
call s:hi('NERDTreeOpenable', s:string, s:base, s:bold)
...
if has("gui_win32")
    call s:hi('Cursor', s:base, s:string, s:bold)
endif
