...
"GitHub:       https://github.com/google/vim-colorscheme-primary-fork

hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'primary-fork'
let s:disable_italic = get(g:,'colorscheme_primary-fork_disable_italic', 0)
let s:enable_transparent_bg = get(g:,'colorscheme_primary-fork_enable_transparent_bg', 0)
